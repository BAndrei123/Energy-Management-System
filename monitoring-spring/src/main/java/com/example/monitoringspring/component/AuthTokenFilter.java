package com.example.monitoringspring.component;



import com.example.monitoringspring.service.JwtUtilsService;
...
public class AuthTokenFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    if (jwt != null && jwtUtilsService.validateJwtToken(jwt)) {
      ...
      // Create a UsernamePasswordAuthenticationToken with null credentials and no authorities
